...
function Colorsbar() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/predict_pattern', formToSend, {
                headers: { 'Content-Type': 'application/json' }
            });
            setMessage(response.data.pattern);
            setPred(response.data.pattern);
        ...
        //         method: 'post',
        //         url: 'http://localhost:8000/predict_pattern',
        //         data: formToSend,
                ...
                return (
                    <>
                        ...
                        <div className="sub-div">
                            ...
                            <div>
                                <input type="radio" id="Outerwear" name="category" value="Outerwear"
                            ...
                            <div>
                                <input type="radio" id="Tshirts" name="category" value="Tshirts"
                                       onChange={handleChange}/>
                ...
                return (
                    <>
                        <div className="sub-div">
                            <label htmlFor="categories">Categories</label>
                            <div>
                                <input type="radio" id="Dresses" name="category" value="Dresses"
                                       onChange={handleChange}/>
        ...
        <div className="sidebar">
            <div className="top">
                <Link to="/" style={{textDecoration: "none"}}>
                    <PatternIcon/>
                    <span className="logo">Patterns</span>
                </Link>
            </div>
            <hr/>
