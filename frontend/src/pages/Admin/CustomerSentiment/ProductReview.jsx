  ...
  return (
    <div className="product-review">
      ...
      <div className="product-details">
        ...
        <p>
          <strong>Type:</strong> {product.cloth_type}
        </p>
        <p>
        ...
        <div className="review-analysis">
          ...
          <button onClick={() => goToReviewPage("positive", product.id)}>
            Positive Reviews
          </button>
          <button onClick={() => goToReviewPage("negative", product.id)}>
            Negative Reviews
          </button>
          <button
            onClick={() => goToReviewPage("slightly-positive", product.id)}
          >
            Slightly Positive Reviews
          </button>
          <button
            onClick={() => goToReviewPage("slightly-negative", product.id)}
          >
            Slightly Negative Reviews
          </button>
          <button onClick={() => goToReviewPage("neutral", product.id)}>
            Neutral Reviews
          </button>
        </div>
      </div>
